...
export default function CorpusDetailPage({ kind }) {
  ...
  const topicId = definitionGuide?.topicId || topicForText(item.text);
  const topic = curriculum.find((entry) => entry.id === topicId);
